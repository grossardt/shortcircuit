...
class PauliHamiltonian:
    ...
    def shorten_circuit(self, unitary, limit = 0.1):
        ...
        for o in self.operators:
            if o != 'I'*self.qubits: # ignore identity
                ...
                e = (self.circuit_deviation(unitary, ops) - initial_error) / pauli_circuit(o,1).depth()
                if e < err:
                    err = e
                    remove_op = o
    ...
    def find_better_perm(self, unitary, min_improvement = 0.001, verbose = True):
...
h0 = h.crop(80) # begin with cutting the 80 Paulis with smallest coefficient to save time
